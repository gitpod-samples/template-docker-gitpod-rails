#This Dockerfile is for local dev environment, if you're not using Gitpod. Otherwise, the docker-compose will pull the image and Gitpod wiill make the necessary conversions to make it work in the Gitpod Workspace
